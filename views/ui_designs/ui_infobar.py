...
class Ui_InfoBar(object):
    def setupUi(self, Form):
        ...
        self.frame.setStyleSheet("QFrame#frame{background-color: rgba(56,59,31,128);border-radius: 10px;}")
    ...
    def retranslateUi(self, Form):
        ...
        self.prompt_type_label.setText(QCoreApplication.translate("Form", "\u63d0\u793a", None))
        self.prompt_info_label.setText(QCoreApplication.translate("Form", "LabelText", None))
        self.btn_close_prompt.setText(QCoreApplication.translate("Form", "X", None))
